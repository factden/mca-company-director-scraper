...
| `email` | string | Director's contact email where available. Paid contact enrichment; empty when not fetched or not on file |
| `phone` | string | Director's contact phone where available. Paid contact enrichment; empty when not fetched or not on file |
