...
director returns their profile plus the full **directorship network**.
...
status changes, fresh directorships — and push the delta to your CRM, a webhook, or a Google Sheet via Apify
integrations.
